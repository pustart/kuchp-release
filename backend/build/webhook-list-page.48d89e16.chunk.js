"use strict";(self.webpackChunkmath_kuchp_backend=self.webpackChunkmath_kuchp_backend||[]).push([[4121],{11199:(U,L,t)=>{t.r(L),t.d(L,{default:()=>ue});var e=t(67294),a=t(86597),b=t(87751),m=t(16550),O=t(86896),p=t(14087),C=t(17034),D=t(185),c=t(53979),f=t(36989),i=t(75515),M=t(29728),x=t(49066),H=t(41580),_=t(38939),ee=t(49386),te=t(8060),G=t(79031),E=t(37909),N=t(41451),ne=t(63237),le=t(15234),S=t(11047),y=t(45697),V=t(88972);const $=V.ZP.div`
...
`,C=(0,b.ZP)(p)`
  flex-shrink: 0;
`,D=({startActions:c,endActions:f})=>c||f?e.createElement(m.x,{paddingLeft:10,paddingRight:10},e.createElement(m.x,{paddingBottom:4},e.createElement(O.k,{justifyContent:"space-between",alignItems:"flex-start"},c&&e.createElement(p,{wrap:"wrap"},c),f&&e.createElement(C,{pullRight:!0},f)))):null;D.defaultProps={endActions:void 0,startActions:void 0},D.propTypes={endActions:a.node,startActions:a.node}},49386:(U,L,t)=>{t.d(L,{c:()=>f});var e=t(67294),a=t(45697),b=t(88972),m=t(41580),O=t(70004),p=t(11047),C=t(75515);const D=(0,b.ZP)(m.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,c=(0,b.ZP)(m.x)`
  ...
  width: 100%;
  border: none;
`,f=({children:i,icon:M,...x})=>e.createElement("div",null,e.createElement(O.i,null),e.createElement(c,{as:"button",background:"primary100",padding:5,...x},e.createElement(p.k,null,e.createElement(D,{"aria-hidden":!0,background:"primary200"},M),e.createElement(m.x,{paddingLeft:3},e.createElement(C.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600"},i)))));f.propTypes={children:a.string.isRequired,icon:a.node.isRequired}}}]);

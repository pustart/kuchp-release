...
domains=("kuchp-math.ru www.kuchp-math.ru" "admin.kuchp-math.ru www.admin.kuchp-math.ru")
email="math.kuchp@gmail.com" # Adding a valid address is strongly recommended
